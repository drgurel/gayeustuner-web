...
const services = [
  ...
  },
  {
    ...
    description:
      "Corrección de dientes torcidos y trastornos de mordida en niños y adolescentes con brackets metálicos o cerámicos.",
    href: "/es/services/tratamiento-brackets",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
