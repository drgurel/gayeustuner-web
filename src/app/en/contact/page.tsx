...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Dr. Gaye Üstüner. Flora Residence, Ataşehir, Istanbul. Reach out for appointments and information.",
  alternates: {
    canonical: "https://www.gayeustuner.com/en/contact",
    languages: { tr: "https://www.gayeustuner.com/iletisim", en: "https://www.gayeustuner.com/en/contact" },
  },
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-[var(--color-text-light)] leading-relaxed">
                Contact us for questions about your child&apos;s dental health or to request an appointment.
              </p>
            </div>
          </div>
        </section>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-secondary)] mb-1">Address</h3>
                      <p className="text-[var(--color-text-light)]">Flora Residence, Ataşehir, Istanbul</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-secondary)] mb-1">Phone / WhatsApp</h3>
                      <a
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[var(--color-secondary)] mb-1">Location</h3>
                      <a
                ...
                <div className="mt-6 rounded-xl overflow-hidden border border-[var(--color-border)]">
                  <iframe
                    ...
                    title="Dr. Gaye Üstüner - Pediatric Dentist Location"
                  />
                </div>
                ...
                <div className="mt-12" id="appointment">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        title: "First Dental Visit (0-3 Years)",
                        description: "Evaluation of your baby's first teeth and family guidance.",
                      },
                      {
                        title: "Check-up Appointment",
                        description: "Regular dental health check-up and preventive treatments.",
                      },
                      {
                        title: "General Examination",
                        description: "Overall evaluation and treatment planning.",
                      },
                      {
                        title: "Orthodontic Evaluation",
                        description: "Assessment of dental and jaw irregularities.",
                      },
                    ].map((appointment) => (
                      <div
